...
pub(in crate::document::parser) enum Frame<'a> {
    Object {
        pairs: ObjectMap,
...
impl<'a> Frame<'a> {
    pub(in crate::document::parser) fn new_object() -> Self {
    ...
    pub(in crate::document::parser) fn new_array() -> Self {
        Frame::Array {
            items: Vec::with_capacity(8),
        }
    }

    pub(in crate::document::parser) fn into_value(self) -> Value {
        match self {
