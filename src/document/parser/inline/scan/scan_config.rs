...
#[derive(Clone, Copy)]
pub(in crate::document::parser::inline) struct ScopeFrame(u8);

impl ScopeFrame {
    /// `kind` is the opener byte, `b'{'` or `b'['`.
    #[inline]
    pub(in crate::document::parser::inline) fn pack(
        kind: u8,
        saved_in_key: bool,
    ...
    #[inline]
    pub(in crate::document::parser::inline) fn kind(self) -> u8 {
        if self.0 & 1 == 0 {
            b'{'
        } else {
            b'['
    ...
    #[inline]
    pub(in crate::document::parser::inline) fn saved_in_key(self) -> bool {
        self.0 & 0b0010 != 0
    }

    #[inline]
    pub(in crate::document::parser::inline) fn saved_seg_start(self) -> bool {
        self.0 & 0b0100 != 0
    }

    #[inline]
    pub(in crate::document::parser::inline) fn saved_raw(self) -> bool {
        self.0 & 0b1000 != 0
    }
}

/// Why the shared scanner loop stopped.
pub(in crate::document::parser::inline) enum ScanStop {
...
pub(in crate::document::parser::inline) trait ScanCfg {
...
pub(in crate::document::parser::inline) struct FindFast;
...
/// validation differ.
pub(in crate::document::parser::inline) struct FindQ;
...
pub(in crate::document::parser::inline) struct ScanFast;
...
/// clear `value_start`.
pub(in crate::document::parser::inline) struct ScanQ;
...
pub(in crate::document::parser::inline) struct SplitFast;
...
pub(in crate::document::parser::inline) struct SplitQ;
