...
pub(in crate::document::parser) enum Separator<'a> {
...
pub(in crate::document::parser) fn require_sep_end(
    rest: &str,
    line_num: usize,
    line_start: u32,
    column: u32,
...
pub(in crate::document::parser) fn classify_separator(after_colon: &str) -> Separator<'_> {
