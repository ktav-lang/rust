...
случайным пробелом на краю — уходит в форму со снятым отступом
`( ... )` или, если снятие отступа исказит содержимое, в дословную
форму `(( ... ))`; какую бы форму writer ни выбрал, round-trip
байт-в-байт без потерь.

Какая именно блочная форма — зависит от того, *где* пробелы. Замыкающий
переживает форму со снятым отступом, потому что снимается только общий
**ведущий** отступ:
...
А вот ведущие пробелы вынуждают взять дословную форму — снятие отступа
их бы съело:
...
строки из одних пробелов, или все строки с отступом (не от чего
